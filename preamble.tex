...
\tikzstyle{init}=[circle,double,thick,draw=black!75,fill=darkblue!20,minimum size=8mm]
\tikzstyle{red place}=[place,draw=red!75,fill=red!20]
\tikzstyle{simple place}=[minimum size=6mm]
...
\definecolor{sync}{RGB}{0, 102, 204}
\definecolor{update}{RGB}{0, 153, 255}
