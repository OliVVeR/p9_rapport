...
%our goal
Our goal for this project is to generate a validated schedule which is produced by analysing a model that models the behaviour and battery of a nano-satellite. 
