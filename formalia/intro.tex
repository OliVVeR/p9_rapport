...
This project aims to accommodate this problem by providing a tool that can produce schedules for such systems and test the robustness of the schedules in order to calculate how confident the tool is in its correctness.\jfx{"confident the tool is in its correctness." => "confident the tool is in the produced schedule." yes, no?}
