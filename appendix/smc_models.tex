...
\begin{figure}[H]
	...
	\path[->,black, thick] (l5) edge[bend right=45] node [midway, right][align=left]{
...
\begin{figure}[H]
	...
	\path[->,black, thick] (l1) edge[loop above] node [midway, above][align=left]{
		\textcolor{guard}{on \&\& a <= 0}\\
		\textcolor{sync}{empty!}\\
		\textcolor{update}{on = false, i = 0}} (l1);
	\path[->,black, thick] (l0) edge[loop above] node [midway, above][align=left]{
		\textcolor{guard}{on \&\& a <= 0}\\
		\textcolor{sync}{empty!}\\
