...
\begin{figure}[H]
	\begin{lstlisting}[language=my_c, caption={Declarations for OrbitWindows template}, label=lst:orbitwindows_code]
clock wtime;
...
system Processor, EnergySource, Scheduler, Insolation, OrbitalWindows;
	\end{lstlisting}
\end{figure}
