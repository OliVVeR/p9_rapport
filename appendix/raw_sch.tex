...
\begin{figure}[H]
\begin{lstlisting}[caption={The raw schedule format. Note the first transition at line 5 that displays that we enter a running state i.e. we start executing a payload. We stop executing they payload after 15 time units(minutes).}, label=lst:raw, language=text]
State:
