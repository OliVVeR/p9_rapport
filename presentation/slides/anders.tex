...
\begin{frame}{Output}{Battery capacity}
	\begin{equation*}
		simulate\ 100 \; [<=\ ScheduleLength]\; \{ a,\ b\}
	\end{equation*}
	\begin{figure}
...
% Output 3.1
\begin{frame}{Output}{Active and Running Visual}
	\begin{equation*}
...
% Reflection 2 - vinduer
\begin{frame}{Reflection}{Windows}
	Too simple
	\begin{itemize}
