...
\begin{table}[]
	...
	\end{tabular}
	\caption{Comparison of Battery Models}
\end{table}
\end{frame}
...
\begin{frame}[fragile]{Robustness}{\insertsubsection}
	...
	\begin{figure}[h]
		...
		\begin{lstlisting}[language=my_c, caption={Variables}, label=lst:queue]
N = 2;
...
RunStart[NumberOfPayloads] = {50,100};
		...
		\end{minipage}\\
		\begin{minipage}{.7\textwidth}
			\begin{lstlisting}[language=my_c, caption={Function}, label=lst:queue]
void enqueue(){
