...
\section{The Problem}
\begin{frame}[fragile]{\insertsection - Why?}
  \begin{itemize}
...
\begin{frame}[fragile]{\insertsection - Requirements}
	\begin{itemize}
		\item Dependencies
		\item Windows
		\item Battery level
...
\section{CORA Model}
\begin{frame}[fragile]{\insertsection - The processor}
	\begin{tikzpicture}
	%Locations
	\node [init] (l0) {$\cup$};
...
\begin{frame}[fragile]{\insertsection - The scheduler}
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
	%Locations
...
\begin{frame}[fragile]{\insertsection - Insolation}
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
	%Locations
...
\begin{frame}[fragile]{\insertsection - Windows}
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
	%Locations
