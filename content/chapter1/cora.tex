...
\label{eq:cora_get_c}
\end{align}
To get the optimal path to \uppLoc{C} we set diagnostic trace to best and run the query seen in \cref{eq:cora_get_c}, the query asks if \uppLoc{C} is reachable.
