...
\end{tabular}}
	\caption{Comparison of actual measure and measures from Peukert model. Specification for the variable loads can be found in \cref{table:variable_loads_list}
	}
...
\end{tabular}}
	\caption{Comparison of actual measure and measures from \gls{kibam}. Specification for the variable loads can be found in \cref{table:variable_loads_list}
	}
	\label{table:t-KiBaM}
\end{table}
