...
\end{itemize}
Since CORA can't use \gls{kibam} or Peukert model because \gls{cora} only support linearly priced automata and only natural numbers. The Ideal model will have to suffice.
