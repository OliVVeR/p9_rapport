\section{Inaccuracies and Assumptions}
...
Introducing the variable idle\_cost to our \nameref{subsec:init} \cref{subsec:init} could alleviate the computation time for producing a schedule in \gls{cora}. It is meant to reduce the number of payloads, by removing operational payloads that run frequently and adds no profit and distribute the cost evenly by the value idle\_cost.
