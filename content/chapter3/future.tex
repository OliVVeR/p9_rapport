...
%when a previous schedule is constructed and the user would like to produce a new schedule with the end state of the previous schedule, this is not possible atm.

\subsection{Multiple windows per schedule}