...
From that results a new question can be raised \textit{``What is the probability that \uppVar{x} is above or equal to 50 when 100 time units have passed?''} in \cref{eq:q3} a query have been constructed to answer the question.
